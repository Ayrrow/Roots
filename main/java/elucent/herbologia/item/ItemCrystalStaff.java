	...
	public void addInformation(ItemStack stack, EntityPlayer player, List<String> tooltip, boolean advanced){
		if (stack.hasTagCompound()){
			...
			if (comp != null){
				...
				tooltip.add(ChatFormatting.RED + "  +" + this.getPotency(stack) + " potency.");
				tooltip.add(ChatFormatting.RED + "  +" + this.getEfficiency(stack) + " efficiency.");
				tooltip.add(ChatFormatting.RED + "  +" + this.getSize(stack) + " size.");
			}
		}
	}
